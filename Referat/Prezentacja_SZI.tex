...
\begin{document}
		...
		\begin{frame}{Podział pracy}
			\begin{itemize}
				...
				\item Dominik - znajdowanie najefektywniejszej kolejności odwiedzania stolików przez kelnera podczas roznoszenia posiłków (algorytmy genetyczne).
			\end{itemize}
		\end{frame}
		...
		\end{frame}
			...
			\begin{frame}[plain]
				...
				\pgfuseimage{chromosom}
			\end{frame}
			\begin{frame}[plain]{Ocena osobników}
		...
		\end{frame}
			\begin{frame}{Przykład działania}
				...
				\end{enumerate}
			\end{frame}
		\begin{frame}[plain]{Wyniki doświadczenia}
			\pgfdeclareimage[width=12cm,height=7cm]{chromosom}{eksperymentDD.png}
			\pgfuseimage{chromosom}
		\end{frame}
		\begin{frame}[plain]{Wyniki doświadczenia - 100 powtórzeń}
		\pgfdeclareimage[width=11cm,height=8cm]{chromosom}{eksperyment100.png}
		\pgfuseimage{chromosom}
		\end{frame}
		\begin{frame}[plain]{Wyniki doświadczenia - 1000 powtórzeń}
